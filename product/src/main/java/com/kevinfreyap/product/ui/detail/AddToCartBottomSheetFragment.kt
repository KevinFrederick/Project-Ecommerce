...
import com.kevinfreyap.product.databinding.BottomSheetFragmentAddToCartBinding
...
class AddToCartBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val product = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            arguments?.getParcelable(PRODUCT_ARG, ProductUi::class.java)
        } else {
        ...
        if (product != null) {
            binding.tvProductNameBottomSheet.text = product.name
