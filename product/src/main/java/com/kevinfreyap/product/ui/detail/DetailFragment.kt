...
import com.kevinfreyap.product.ui.detail.carousel.ImageCarouselAdapter
import com.kevinfreyap.product.databinding.FragmentDetailBinding
import com.kevinfreyap.product.mapper.toUiModel
import com.kevinfreyap.product.ui.detail.AddToCartBottomSheetFragment.Companion.ADD_CART_REQ
import com.kevinfreyap.product.ui.detail.AddToCartBottomSheetFragment.Companion.BOTTOM_SHEET_TAG
import com.kevinfreyap.product.ui.detail.AddToCartBottomSheetFragment.Companion.IS_SUCCESS
import com.kevinfreyap.product.ui.detail.AddToCartBottomSheetFragment.Companion.PRODUCT_ARG
...
class DetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        childFragmentManager.setFragmentResultListener(ADD_CART_REQ, viewLifecycleOwner) { _, bundle ->
        ...
        binding.btnAddToCartSheet.setOnClickListener {
            currentProduct?.let { product ->
                ...
                val bundle = Bundle().apply {
                    putParcelable(PRODUCT_ARG, product.toUiModel())
                }
